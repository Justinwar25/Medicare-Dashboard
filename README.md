...
How to Use
Download/open the .pbix file in Power BI Desktop
Use filters/slicers (e.g., State) to explore different regions
Hover over points/bars to view tooltips and compare outliers
